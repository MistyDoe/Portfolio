...
const Projects = () => {
    ...
    return (
        ...
        <div className='Content Content__Proj'>
...
A student portal to provide access to all the resources. Authentication is done by using Auth0. The client was built using React and Material UI. For the backend Asp.net framework was used, together with Entity framework core for database management.   </p>           
